...
<section class="login">
    <div class="titulo" style="font-size: 25px;">Staff Login Form</div>
    <form action="homepage.php" method="post" >
        <input type="text" maxlength="15" autofocus="true"  placeholder="enter staff id" required="true">
  ...
  <button type="submit" class="btn btn-warning btn-xs btn-block space">Login</button><br>
   ...
   <div class="olvido">
   <a href="staffregister.php"><button class="btn btn-success btn-xs btn-block space" >register</button></a><br>
