...
<form id="basicBootstrapForm" class="form-horizontal">
    <fieldset><legend style="color:#ccccff"> STAFF REGISTRATION FORM</legend>
    <div class="form-group">
        <br><br>
        <label class="col-xs-3 control-label">Staff ID:</label>
        <div class="col-xs-4">
            <input type="text" maxlength="15" class="form-control" name="firstNa" placeholder="Enter the staff id" autofocus="true" required="" />
        </div>
        <div class="col-xs-4" style="margin-top: -23px;">
    
      <label for="level_of_education">User Role</label>
...
<br><br>
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" maxlength="15" class="form-control" id="validationCustom03" placeholder="Enter your first name" required>
      
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationCustom04">Last Name:</label>
      <input type="text" maxlength="15" class="form-control" id="validationCustom04" placeholder="Enter last name" required>
      
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationCustom05">Contact NO:</label>
      <input type="text" class="form-control" id="validationCustom05" maxlength="10" placeholder="Enter contact no" required>
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom05" maxlength="20" placeholder="Enter the national id no" required>
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" maxlength="30" class="form-control" id="validationCustom03" placeholder="Enter  email address" required>
      
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationCustom04">Poster Address</label>
      <input type="text" maxlength="50" class="form-control" id="validationCustom04" placeholder="Enter postal address" required>
      
    </div>
    </div>
      <div class="form-row">
    <div class="col-md-3 mb-3">
      <label for="validationCustom03">Level of Education:</label>
       <select class="form-control"> 
                                            <option>Select</option>
   <option value="AFG">Doctorate</option>
    <option value="AFG">PHP</option>
    <option value="ALA">MASTERS</option>
    <option value="ALB">DEGREE</option>
    <option value="ALB">DIPLOMA</option>
    <option value="ALB">CERTIFICATE</option>
